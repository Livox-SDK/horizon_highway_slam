...
if(horizon_highway_slam_CONFIG_INCLUDED)
  return()
endif()
set(horizon_highway_slam_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(horizon_highway_slam_SOURCE_PREFIX /root/horizon_highway_slam)
  set(horizon_highway_slam_DEVEL_PREFIX /root/horizon_highway_slam/build/devel)
  set(horizon_highway_slam_INSTALL_PREFIX "")
  set(horizon_highway_slam_PREFIX ${horizon_highway_slam_DEVEL_PREFIX})
else()
  set(horizon_highway_slam_SOURCE_PREFIX "")
  set(horizon_highway_slam_DEVEL_PREFIX "")
  set(horizon_highway_slam_INSTALL_PREFIX /usr/local)
  set(horizon_highway_slam_PREFIX ${horizon_highway_slam_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'horizon_highway_slam' is deprecated")
...
set(horizon_highway_slam_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/root/horizon_highway_slam/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/jsoncpp;/usr/include/libxml2;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/hdf5/openmpi;/usr/include/tcl;/usr/include/python2.7 " STREQUAL " ")
  set(horizon_highway_slam_INCLUDE_DIRS "")
  set(_include_dirs "/root/horizon_highway_slam/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/jsoncpp;/usr/include/libxml2;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/hdf5/openmpi;/usr/include/tcl;/usr/include/python2.7")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${horizon_highway_slam_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'horizon_highway_slam' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'horizon_highway_slam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/horizon_highway_slam/${idir}'.  ${_report}")
    endif()
    _list_append_unique(horizon_highway_slam_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND horizon_highway_slam_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND horizon_highway_slam_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT horizon_highway_slam_NUM_DUMMY_TARGETS)
      set(horizon_highway_slam_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::horizon_highway_slam::wrapped-linker-option${horizon_highway_slam_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR horizon_highway_slam_NUM_DUMMY_TARGETS "${horizon_highway_slam_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::horizon_highway_slam::wrapped-linker-option${horizon_highway_slam_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND horizon_highway_slam_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/horizon_highway_slam/build/devel/lib;/root/horizon_highway_slam/build/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(horizon_highway_slam_LIBRARY_DIRS ${lib_path})
      list(APPEND horizon_highway_slam_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'horizon_highway_slam'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND horizon_highway_slam_LIBRARIES ${lib})
    endif()
  endif()
...
set(horizon_highway_slam_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${horizon_highway_slam_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 horizon_highway_slam_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${horizon_highway_slam_dep}_FOUND)
      find_package(${horizon_highway_slam_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${horizon_highway_slam_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(horizon_highway_slam_INCLUDE_DIRS ${${horizon_highway_slam_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(horizon_highway_slam_LIBRARIES ${horizon_highway_slam_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${horizon_highway_slam_dep}_LIBRARIES})
  _list_append_deduplicate(horizon_highway_slam_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(horizon_highway_slam_LIBRARIES ${horizon_highway_slam_LIBRARIES})

  _list_append_unique(horizon_highway_slam_LIBRARY_DIRS ${${horizon_highway_slam_dep}_LIBRARY_DIRS})
  list(APPEND horizon_highway_slam_EXPORTED_TARGETS ${${horizon_highway_slam_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${horizon_highway_slam_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
